...
const (
	...
	// (e.g. gitmap-v19/v6/v7) and exits non-zero on any hit. Used as a // gitmap-legacy-ref-allow
...
// Defaults catch the gitmap-v19/v6/v7 → v8 rename regression class. // gitmap-legacy-ref-allow
const (
	...
	DefaultAuditLegacyReplace   = "gitmap-v19"
